        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-6 pl-4 border-l-2 border-menakta-primaryFirst/30">
              <div>
                <h3 className="font-clash text-white font-semibold mb-2">Personal Data</h3>
                <p className="font-clash text-[#D4E5FF] leading-relaxed">
              ...
              <div>
                <h3 className="font-clash text-white font-semibold mb-2">Usage Data</h3>
                <p className="font-clash text-[#D4E5FF] leading-relaxed">
              ...
              <div>
                <h3 className="font-clash text-white font-semibold mb-2">Cookies and Tracking Technologies</h3>
                <p className="font-clash text-[#D4E5FF] leading-relaxed">
