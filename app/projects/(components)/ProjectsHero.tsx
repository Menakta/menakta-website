  ...
  return (
    <section className="group relative min-h-screen overflow-hidden flex items-center justify-center transition-colors duration-300 bg-theme-bg-primary">
        ...
        >
          <defs>
            ...
            >
              ...
              <stop offset="50%" stopColor="#0041D5" stopOpacity="0.5" />
        ...
        >
          <defs>
            <linearGradient
              ...
              y2="0%"
            >
              <stop offset="0%" stopColor="#0041D5" stopOpacity="0.6" />
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-[5]">
        ...
        <div className="absolute top-1/4 right-1/5 w-1 h-1 bg-menakta-primarySecond/40 rounded-full animate-float-medium" />
      </div>
    </section>
  );
}
