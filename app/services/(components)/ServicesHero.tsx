  ...
  return (
    <section className="group relative min-h-screen bg-menakta-secondaryFirst overflow-hidden flex items-center justify-center">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/images/servicesHero.jpg')" }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="font-clash text-menakta-secondarySecond/70 text-base sm:text-lg md:text-xl max-w-2xl mx-auto leading-relaxed opacity-0 animate-[fadeIn_0.8s_ease-out_1s_forwards]">
          From immersive game development to intelligent AI solutions, we offer
          a comprehensive range of services designed to transform your ideas
          into reality.
        </p>

        <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link href="/landing#contact" className="w-full sm:w-auto">
            <button className="w-full sm:w-auto font-clash px-8 py-4 bg-gradient-to-r from-menakta-primaryFirst to-menakta-primarySecond text-menakta-secondarySecond rounded-full text-sm uppercase tracking-wider hover:shadow-lg hover:shadow-menakta-primarySecond/30 active:scale-95 transition-all duration-300 opacity-0 animate-[fadeInUp_0.6s_ease-out_1.2s_forwards]">
              Get Started
            </button>
          </Link>
