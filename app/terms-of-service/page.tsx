        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-6 pl-4 border-l-2 border-menakta-primaryFirst/30">
              <div>
                <h3 className={`font-clash font-semibold mb-2 text-theme-text-primary`}>Our Property</h3>
                <p className={`font-clash leading-relaxed text-theme-text-secondary`}>
              ...
              <div>
                <h3 className={`font-clash font-semibold mb-2 text-theme-text-primary`}>Client Deliverables</h3>
                <p className={`font-clash leading-relaxed text-theme-text-secondary`}>
              ...
              <div>
                <h3 className={`font-clash font-semibold mb-2 text-theme-text-primary`}>Portfolio Rights</h3>
                <p className={`font-clash leading-relaxed text-theme-text-secondary`}>
